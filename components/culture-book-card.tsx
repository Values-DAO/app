    ...
    <div className="bg-white p-4 mx-4 rounded-xl">
      <div className="flex gap-x-3">
        ...
        <div className="flex flex-col gap-y-1 min-w-0 w-full">
          ...
          {post.hasPhoto && (
            <div className="relative w-full h-40 md:h-64 overflow-hidden rounded-[18px] my-2">
              <Image
                src="https://gateway.pinata.cloud/ipfs/bafkreiboqcwf7giobg4j4g4gkix4yloddlqr7mxgj7o6e4srtxbdizma3a"
                layout="fill"
                objectFit="cover"
                alt="photo"
