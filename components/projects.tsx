      ...
      <Table>
        ...
        <TableBody>
          {projects.map((project) => (
            <TableRow
              key={project.id}
              className="cursor-pointer relative group text-[19px] hover:bg-yellow-100 hover:shadow-lg hover:scale-[1.02]  transition-transform duration-200 ease-in-out"
              onClick={() => {
              ...
              title={`Click to view ${project.name} community values and mint them.`}
            >
              ...
              <TableCell
                title={`${
                  project.verified
                    ? `Click to visit ${project.name} community values page`
                    : `Values for this project were generated by our AI engine`
                }`}
              >
                <div className="flex justify-center items-center">
                  {project.verified ? (
                    <a href={project.valuesSource} target="_blank">
                      <VerifiedIcon />{" "}
                    </a>
                  ) : (
                    <p>AI</p>
