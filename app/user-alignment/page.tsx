...
const Loading = () => (
  <div className="fixed inset-0 flex flex-col items-center justify-center bg-opacity-50 backdrop-filter backdrop-blur-lg">
    ...
    <h4 className="scroll-m-20 text-lg font-light tracking-tight">Loading...</h4>
  </div>
);
    ...
    <div className={"container"}>
      {error ? (
        ...
        <section className="p-4">
          {alignmentScore && viewerUserInfo?.username && targetUserInfo?.username && (
            <div className="  scroll-m-20 text-2xl font-semibold tracking-tight">
              Alignment between {capitalizeFirstLetter(viewerUserInfo.username) ?? viewer} and{" "}
                ...
                viewerUserInfo.spectrum.length > 0 && (
                  ...
                  Score`}
                      ...
                      <div className="flex flex-row gap-2 items-center">
                        ...
                        <span className="text-sm">
                          {" "}
                          {`${capitalizeFirstLetter(targetUserInfo?.username)}'s
                  Score`}
                        </span>
                      </div>
                      <div className="flex flex-row gap-2 items-center">
