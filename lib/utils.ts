...
// Format the raw supply into human-readable units
export const formatSupply = (rawSupply: string) => {
  return ethers.formatUnits(rawSupply, 18);
};
...
export const formSchema = z.object({
  ...
  tokenSymbol: z.string().min(1, "Please provide a symbol").max(16, "Symbol is too long"),
  curatorTreasuryAllocation: z.string().min(1, "Please provide an allocation"),
});
